// backend/src/middleware/uploadCv.js - For CV uploads in admin dashboard
const multer = require('multer');
const { CloudinaryStorage } = require('multer-storage-cloudinary');
const cloudinary = require('../config/cloudinary');

// Configure multer for Cloudinary storage - CV uploads
const storage = new CloudinaryStorage({
  ...
  params: (req, file) => {
    ...
    return {
      folder: 'staffdox/cvs', // Organize CV files separately
      public_id: `cv-${userId}-${uniqueSuffix}`,
